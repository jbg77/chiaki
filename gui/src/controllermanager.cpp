...
static QSet<QString> chiaki_dualsense_controller_guids({
	...
	// macOS
	"050000004c050000e60c000000010000",
	"030072264c050000e60c000000016800",
	// Windows
...
void Controller::SetRumbleEmulated(uint8_t left, uint8_t right, int ms)
{
#ifdef CHIAKI_GUI_ENABLE_SDL_GAMECONTROLLER
	if(!controller)
		return;
	SDL_GameControllerRumble(controller, (uint16_t)left << 8, (uint16_t)right << 8, ms);
#endif
}
